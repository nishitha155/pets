    ...
    useEffect(() => {
      ...
      const fetchProducts = async () => {
        try {
          ...
          const response = await fetch(`https://pets-2.onrender.com/products?specie=${specieFilter}&brand=${brandFilter}&price=${1999}&category=${categoryFilter}`);
    ...
    return (
        ...
        <Header />
            ...
            <div className="mainproduct1">
              ...
              <Image
                src={`https://pets-2.onrender.com/uploads/${item.image}`}
                alt={item.title}
                objectFit="cover"
                boxSize="20vw"
              />
