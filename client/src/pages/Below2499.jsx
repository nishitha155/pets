    ...
    useEffect(() => {
      ...
      const fetchProducts = async () => {
        try {
          ...
          const response = await fetch(`https://pets-2.onrender.com/products?specie=${specieFilter}&brand=${brandFilter}&price=${2499}&category=${categoryFilter}`);
